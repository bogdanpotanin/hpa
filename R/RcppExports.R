...
#' @export	
predict.hpaBinary <- function(model, newdata = NULL, is_prob = TRUE) {
    .Call(`_hpa_predict_Binary`, model, newdata, is_prob)
}
...
#' @export	
summary.hpaBinary <- function(model) {
    .Call(`_hpa_summary_Binary`, model)
}

#' Summary for hpaBinary output
#' @param model Object of class "hpaML"
#' @export	
print.summary.hpaBinary <- function(model) {
    invisible(.Call(`_hpa_print_summary_Binary`, model))
}

#' Plot hpaBinary random errors approximated density
#' @param model Object of class "hpaBinary"
#' @export	
plot.hpaBinary <- function(model) {
    invisible(.Call(`_hpa_plot_Binary`, model))
}

#' Calculates AIC for "hpaBinary" object
#' @description This function calculates AIC for "hpaBinary" object
#' @export	
AIC.hpaBinary <- function(model) {
    .Call(`_hpa_AIC_Binary`, model)
}

#' Calculates log-likelihood for "hpaBinary" object
#' @description This function calculates log-likelihood for "hpaBinary" object
#' @export	
logLik.hpaBinary <- function(model) {
    .Call(`_hpa_logLik_Binary`, model)
}
...
#' @export	
predict.hpaML <- function(model, newdata = matrix(1,1)) {
    .Call(`_hpa_predict_ML`, model, newdata)
}
...
#' @export	
summary.hpaML <- function(model) {
    .Call(`_hpa_summary_ML`, model)
}

#' Summary for hpaML output
#' @param model Object of class "hpaML"
#' @export	
print.summary.hpaML <- function(model) {
    invisible(.Call(`_hpa_print_summary_ML`, model))
}

#' Calculates AIC for "hpaML" object
#' @description This function calculates AIC for "hpaML" object
#' @export	
AIC.hpaML <- function(model) {
    .Call(`_hpa_AIC_ML`, model)
}

#' Calculates log-likelihood for "hpaML" object
#' @description This function calculates log-likelihood for "hpaML" object
#' @export	
logLik.hpaML <- function(model) {
    .Call(`_hpa_logLik_ML`, model)
}
...
#' @export
predict.hpaSelection <- function(model, newdata = NULL, method = "HPA", is_cond = TRUE, is_outcome = TRUE) {
    .Call(`_hpa_predict_Selection`, model, newdata, method, is_cond, is_outcome)
}
...
#' @export	
summary.hpaSelection <- function(model) {
    .Call(`_hpa_summary_Selection`, model)
}

#' Summary for hpaSelection output
#' @param model Object of class "hpaSelection"
#' @export	
print.summary.hpaSelection <- function(model) {
    invisible(.Call(`_hpa_print_summary_Selection`, model))
}
...
#' @export	
plot.hpaSelection <- function(model, is_outcome = TRUE) {
    .Call(`_hpa_plot_Selection`, model, is_outcome)
}

#' Calculates AIC for "hpaSelection" object
#' @description This function calculates AIC for "hpaSelection" object
#' @export	
AIC.hpaSelection <- function(model) {
    .Call(`_hpa_AIC_Selection`, model)
}
...
#' @export	
logLik.hpaSelection <- function(model) {
    .Call(`_hpa_logLik_Selection`, model)
}
